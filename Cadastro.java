...
public class Cadastro {
    ...
    public Cadastro(){
        ...
        Funcionarios[tam++] = new Funcionario("João", "653.765.255-63", 8.87, 35, true);
        ...
        Funcionarios[tam++] = new Funcionario("Gustavo", "763.165.867-77", 14.20, 44, false);
    }
    ...
    public void editaSalario(){
        Scanner sc3 = new Scanner(System.in);
            ...
            for(int i = 0; i < tam; i ++){
                ...
                Funcionarios[i].setCargaHorariaSemanal(sc3.nextDouble());
                System.out.println("Qual o novo valor da hora do(a) funcionario(a)");
                Funcionarios[i].setValorHoraTrabalhada(sc3.nextDouble());
            }
        }
    }
